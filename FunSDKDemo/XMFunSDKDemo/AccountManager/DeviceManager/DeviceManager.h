...
- (void)addDeviceByDeviseSerialnumber:(NSString*)serialNumber deviceName:(NSString *)deviceName;//通过输入设备序列号进行添加
...
- (void)addDeviceBySerialNum:(NSString *)serialNumber deviceName:(NSString *)name;//搜索到之后，再选择要添加的设备添加
#pragma mark - 开始快速配置
