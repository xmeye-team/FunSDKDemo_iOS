//
//  PlayCloudVideoViewController.m
//  FunSDKDemo
//
...
@interface PlayCloudVideoViewController () <DateSelectViewDelegate,CloudVideoConfigDelegate,MediaplayerControlDelegate,basePlayFunctionViewDelegate,MediaPlayBackControlDelegate>
{
    ...
    CloudVideoConfig *videoConfig;       //云视频文件管理器
...
@implementation PlayCloudVideoViewController
...
- (void)startSearchFile {
    ...
    [videoConfig searchCloudVideo:dateView.date];
}
#pragma mark - 预览对象初始化
- (void)initDataSource {
